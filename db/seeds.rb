...
cclass12 = CharacterClass.create(character_id: c1.id, class_name: "Cleric", level: 2)
cclass21 = CharacterClass.create(character_id: c2.id, class_name: "Fighter", level: 1)
cclass22 = CharacterClass.create(character_id: c2.id, class_name: "Fighter", level: 2)
cclass31 = CharacterClass.create(character_id: c3.id, class_name: "Rogue", level: 1)
cclass32 = CharacterClass.create(character_id: c3.id, class_name: "Rogue", level: 2)
cclass41 = CharacterClass.create(character_id: c4.id, class_name: "Wizard", level: 1)
